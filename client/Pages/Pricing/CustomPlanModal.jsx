...
import { customSEOPlanList, shopifyCROplanList, storeCustomizationList } from "../../Assets/Mocks/CustomSEO.mock";
import CustomServiceDesign from "./CustomServiceDesign";
...
export default function CustomPlanModal({ backbutton }) {
  ...
  const list =
    type === "theme" ? shopifyCROplanList() : type === "seo" ? customSEOPlanList() : shopifyCROplanList();
  ...
  const title =
    type === "theme"
      ...
      : t("common.Conversion rate optimization plans");

  return (
    <Page title={title} backAction={backbutton} padding="0">
      <BlockStack gap={400}>
        <CustomServiceDesign profileData={profileData} type={customType}></CustomServiceDesign>
        <Card>
          <BlockStack gap="400">
            <BlockStack gap="200" align="center">
              <Text as="h2" variant="headingLg" alignment="center">
                ...
                {type === "seo"
                  ...
                  : // : t("common.Choose your conversion rate optimization plans")}
